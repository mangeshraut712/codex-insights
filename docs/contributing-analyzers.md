...
Skill or install-command changes must update [README.md](../README.md), [docs/install.md](install.md), [docs/claude-insights.md](claude-insights.md), and `plugin/codex-insights/skills/insights/SKILL.md` together.
