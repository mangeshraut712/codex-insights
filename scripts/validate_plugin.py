...
Vendored from openai/codex plugin-creator (`codex-rs/skills/src/assets/samples/plugin-creator/scripts/validate_plugin.py`).
Keep this file aligned with that source. Do not add product-specific checks here.
"""
